...
@usuario_controller.route("/proprietario/usuarios", methods=["GET", "POST"])
@requer_autenticacao
...
def gestao_proprietario():
    if request.method == "POST":
        ...
        return redirect("/proprietario/usuarios")
...
@usuario_controller.route("/admin/atendentes", methods=["GET", "POST"])
@requer_autenticacao
